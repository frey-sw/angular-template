...
import { of } from 'rxjs';
import { AuthService, IResetRequest, MessagingService, SharedTestModule } from '@app-core';
      ...
      await TestBed.configureTestingModule({
        ...
        providers: [
          MessagingService,
          {
            ...
            useValue: { snapshot: { params: { token } } },
          },
        ],
      }).compileComponents();
    });
  ...
  describe('Wrong mail', () => {
    beforeEach(async () => {
      await TestBed.configureTestingModule({
        ...
        providers: [MessagingService, { provide: ActivatedRoute, useValue: { snapshot: { params: { token: undefined } } } }],
      }).compileComponents();
    });
